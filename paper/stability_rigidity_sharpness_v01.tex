...
% This section is intentionally conservative in v0.1.
% A systematic literature search must be completed before submission.

The results sit at the intersection of quantitative near-equality problems,
operator-norm commutator estimates, almost-invariant subspaces, and stability
questions for finite projective decompositions.  The exact relationship with
existing quantitative results for almost commuting projections and unitaries
requires a dedicated priority audit.

Accordingly, this draft makes no claim of historical priority.  Before
submission, the related-work section will distinguish:
(i) estimates controlling projectors or invariant subspaces from commutator
norms;
(ii) stability and near-equality theorems for matrix/operator inequalities;
(iii) results on almost commuting matrices or projections; and
(iv) formalized operator theory and quantum foundations relevant to the
