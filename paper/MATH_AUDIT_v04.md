...
Reference manuscript: `paper/stability_rigidity_sharpness_v04_submission.tex`
...
2. The sharpness-family `stabilitySharpnessTau` is the tail for the explicit retained pair (cells 0 and 2). In the constructed family this is the relevant top-two tail used in the sharpness argument.
