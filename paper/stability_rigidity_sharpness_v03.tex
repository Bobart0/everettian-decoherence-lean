...
\section{Editorial positioning}

The primary target for the present version is \emph{Linear Algebra and its
Applications}.  Accordingly, the manuscript is organized as a
finite-dimensional matrix/operator paper.  Its principal objects are a finite
family of mutually orthogonal projections summing to the identity, a unitary
operator, operator norms of commutators, a sharp extremal inequality, and a
dimension-free stability theorem.  The projective-record language is
motivational rather than logically necessary and may be further reduced in
the journal-specific version.
