...
`Gleason.busch`, `Gleason.gleason`,
`QuantumFoundations.naimark`,
`QuantumFoundations.Wigner.wigner`,
`QuantumFoundations.Uhlhorn.uhlhorn_finite_dim`,
`QuantumFoundations.BranchesRiedel.riedel`, and
`QuantumFoundations.HistoriesKent.contrary_inferences`.
...
For manuscript version 0.7, the reference development is the CI-verified
