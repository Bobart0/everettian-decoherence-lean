...
\end{quote}
The repository also contains a theorem-by-theorem mapping document and a
dedicated audit module for the publication-facing surface.  The formalization
head preceding the manuscript branch is
\begin{center}
\small\texttt{81eb3ff53f6219749b84491513ff437fe7c545c1}
\end{center}
Its complete CI passed, including the library build, audit aggregate, guards,
and diff-hygiene checks.  For archival submission this commit reference should
be supplemented by a tagged release and a persistent archive identifier.
