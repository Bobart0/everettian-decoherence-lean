...
and the sharpness construction have been formally verified in Lean 4 on the
canonical finite-dimensional Hilbert spaces used by the development; the
paper's coordinate-free formulation is obtained by unitary identification
with these models.
\end{abstract}
...
For manuscript version 0.5, the reference development is the CI-verified
