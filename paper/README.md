...
- `stability_rigidity_sharpness_v05_submission.tex`: current submission-facing draft; witness normalization and optimal top-two sharpness tail clarified.
- `MATH_AUDIT_v05.md`: equation-by-equation manuscript ↔ Lean audit.
...
2. Perform a final prose/notational pass on v0.5 and compile the submission PDF.
...
5. Finalize cover letter and submission metadata.
