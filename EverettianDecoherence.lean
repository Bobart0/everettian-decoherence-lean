...
finie sur une liste ordonnée avec accumulation d'erreurs, et ED5A une
factorisation bipartite finie typée en coordonnées, fournie explicitement et
sans dynamique. Aucune API locale stable ni théorème de décohérence n'est
annoncé.
...
accumulation, and ED5A a typed finite bipartite coordinate factorization,
explicitly supplied and dynamics-free. No stable local API or decoherence
