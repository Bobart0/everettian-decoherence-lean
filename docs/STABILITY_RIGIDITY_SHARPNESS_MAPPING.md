...
Ce mapping v19 formalise les paramètres exacts $\eta,\tau$, les versions
publication-facing des constantes $18,8,4$, les ingrédients complets de la
proposition à budget fixé, la famille diffuse géométrique à $2m$ cellules et
le seuil sharp $1/8$.

La seule différence de représentation substantielle est l'absence d'un objet
Lean unique
$C_{\mathrm{fix}}(A_0)=\lim_{\varepsilon\downarrow0}\sup\cdots$ :
les lemmes qui portent sa preuve sont séparément machine-checkés. Les
développements de Taylor/tangents restent également au niveau analytique du
manuscrit et ne sont pas revendiqués comme théorèmes Lean séparés.
