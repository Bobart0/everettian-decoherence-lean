...
collects exact cut-envelope rigidity, quantitative two-cell stability including the v12 finite constant 18, the universal asymptotic coefficient 8, the ultra-near coefficient 4, and the three-dimensional sharpness family attaining the constants 8 and 4. It changes no T0--T5 physical interpretation and makes no
